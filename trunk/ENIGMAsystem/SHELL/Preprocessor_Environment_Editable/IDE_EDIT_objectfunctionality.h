...
variant enigma::OBJ_obj_player::myevent_create()
{
  ...
  {
    argument_relative = 1;
    action_create_object(gun_thing, 0, 0);
...
variant enigma::OBJ_gun_thing::myevent_create()
{
  enigma::temp_event_scope ENIGMA_PUSH_ITERATOR_AND_VALIDATE(this);
...
variant enigma::OBJ_gun_thing::myevent_step()
{
  enigma::propagate_locals(this);
...
variant enigma::OBJ_gun_thing::myevent_draw()
{
  if (!(visible)) return 0;
image_index+=image_speed;
...
variant enigma::OBJ_fountain::myevent_keyboard_32()
{
...
variant enigma::OBJ_fountain::myevent_keypress_32()
{
...
variant enigma::OBJ_gore_test::myevent_keypress_32()
{
  ...
  {
    argument_relative = 1;
    action_create_object(gore_fountain_last, 0, 0);
...
variant enigma::OBJ_gore_fountain_last::myevent_create()
{
  enigma::temp_event_scope ENIGMA_PUSH_ITERATOR_AND_VALIDATE(this);
...
variant enigma::OBJ_gore_fountain_last::myevent_alarm_0()
{
  { if ((alarm[0] == -1) or (alarm[0]--)) return 0; }
action_kill_object();
...
variant enigma::OBJ_gore_fountain_last::myevent_step()
{
  enigma::propagate_locals(this);
