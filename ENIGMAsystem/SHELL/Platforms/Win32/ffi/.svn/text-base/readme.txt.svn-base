LibFFI is a cross platform set of functions supporting all sorts of calling conventions,
including cdecl and stdcall for DLLs on Windows. It's one of the most useful libraries I
have run into, despite the fact that aside from ENIGMA, I can't think of any another use
